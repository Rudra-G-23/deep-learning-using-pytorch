...
| 11 | CNN using PyTorch | [📒](https://www.kaggle.com/code/rudraprasadbhuyan/cnn-using-pytorch-fashion-mnist-gpu/) [📒](https://www.kaggle.com/code/rudraprasadbhuyan/cnn-optuna-using-pytorch-fashion-mnist-gpu/) | [🧑‍🏫](https://youtu.be/hkiBZLRFvO4?si=pbJB9XAWJn2Tu3uM) |
...
2. [Tensors in PyTorch](./02-tensors-in-pytorch/tensors-in-pytorch.ipynb)
3. [PyTorch Autograd](./03-pytorch-autograd/pytorch-autograd.ipynb)
4. [Simple PyTorch Training Pipeline](./04-simple-pytorch-training-pipeline/simple-pytorch-training-pipeline.ipynb)
5. PyTorch NN Module
   - [Simple PyTorch NN Module](./05-pytorch-nn-module/simple-pytorch-nn-module.ipynb)
   - [Simple PyTroch Pipeline using NN Module](./05-pytorch-nn-module/pytorch-training-pipeline-using-nn-module.ipynb)
6. PyTorch Dataset & DataLoader 
   - [Demo](./06-pytorch-dataset-and-dataloader/dataset-and-dataloader-class-in-pytorch.ipynb)
   - [Training Pipeline Improvement](./06-pytorch-dataset-and-dataloader/pytorch-training-pipeline-using-dataset-dataloader.ipynb)
7. [ANN Fashion MINST PyTorch](./07-ann-fashion-mnist-pytorch/ann-fashion-mnist-pytorch.ipynb)
8. [Training on GPU](./08-training-on-gpu/ann-fashion-mnist-pytorch-training-on-gpu.ipynb)
9. [Optimized the NN](./09-optimized-the-nn/ann-fashion-mnist-pytorch-gpu-optimized.ipynb)
10. [Optuna x Torch](./10-optuna-x-torch/ann-fashion-mnist-pytorch-gpu-optimized-optuna.ipynb)
11. [CNN using the PyTorch](./11-cnn-using-the-pytorch/cnn-using-pytorch-fashion-mnist-gpu.ipynb)
12. [Transfer Learning (vgg16)](./12-transfer-learning-vgg16/transfer-learning-vgg16-fashion-mnist-pytorch-gpu.ipynb)
13. [RNN using PyTorch](./13-rnn-using-pytorch/rnn-using-pytorch.ipynb)
14. [LSTM using PyTorch](./14-lstm-using-pytorch/lstm-using-pytorch-next-word-predictor.ipynb)
